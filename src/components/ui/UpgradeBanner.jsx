...
export default function UpgradeBanner({ message = 'Upgrade to Pro to unlock this feature.' }) {
  ...
  return (
    <div className="flex items-center gap-4 bg-gradient-to-r from-brand-50 to-violet-50 border border-brand-200/40 rounded-2xl px-5 py-4 mb-6 transition-all duration-300 ease-out">
